...
App = {
    ...
    sellItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            ...
            const productPrice1 = web3.utils.toWei(web3.utils.toBN(1));
            //const productPrice = web3.utils.toBN(web3.utils.toWei(1, 'ether'));
            console.log('productPrice',productPrice);
            return instance.sellItem(App.upc, productPrice1, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
    ...
    buyItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            ...
            const walletValue = web3.utils.toWei(web3.utils.toBN(3));
