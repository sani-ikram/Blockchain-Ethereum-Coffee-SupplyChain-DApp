...
contract('SupplyChain', function(accounts) {
    ...
    //msg.value = web3.toWei(2, "ether")
    const valueEther = web3.toWei(2,"ether");
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        await supplyChain.harvestItem(upc, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude,productID,productNotes,productPrice,distributorID,retailerID,consumerID)
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        await supplyChain.buyItem(upc,{value: valueEther});
        ...
        assert.equal(resultBufferOne[0], sku, "Error:Invalid Item Sku");
        assert.equal(resultBufferOne[1], upc, "Error:Invalid Item UPC");
        assert.equal(resultBufferOne[2], consumerID, "Error: Invalid Item OwnerID as it doesn't match new buyer's ID");
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Missing or Invalid originFarmerID')
        assert.equal(resultBufferOne[4], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[5], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[6], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, "Error:Invalid Item Sku");
        assert.equal(resultBufferOne[1], upc, "Error:Invalid Item UPC");
        assert.equal(resultBufferOne[2], consumerID, "Error: Invalid Item as ownerID");
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Missing or Invalid originFarmerID')
        assert.equal(resultBufferOne[4], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[5], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[6], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        resultBufferOne = await supplyChain.fetchItemBufferOne.call(upc, {from: consumerID});
